...
class DsrOptOut(BaseModel):
    ...
    dsr_optout_request_id: str = Field(
...
def lambda_handler(event, context):
    ...
    try:
        ...
        consumer_id = optout_obj.ext_consumer_id
        dealer_id = optout_obj.dealer_identifier
        ...
        with DBSession() as session:
            ...
            data = {
                ...
                "dsr_request_id": optout_obj.dsr_optout_request_id,
                "dsr_request_timestamp": optout_obj.dsr_request_timestamp,
                "is_enterprise": optout_obj.is_enterprise
            }
