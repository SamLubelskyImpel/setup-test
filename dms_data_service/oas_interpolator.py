...
from swagger.api_interpolation_data import DMS_DATA_SERVICE_INTERPOLATION_DATA
        ...
        for line in lines:
            ...
            for place_holder_name in place_holder_names:
                ...
                if place_holder in line:
                    ...
                    interpolation_lines = interpolation_dict[place_holder_name].splitlines()
...
interpolate_yaml_file('dms_data_service/swagger/dms-data-service-oas.yaml', DMS_DATA_SERVICE_INTERPOLATION_DATA)
