...
def lambda_handler(event: Any, context: Any) -> Any:
    ...
    try:
        ...
        with DBSession() as session:
            query = (
                session.query(DealerIntegrationPartner.id, Dealer.product_dealer_id, Dealer.metadata_, ActivityType.type, Activity.activity_due_ts, Activity.activity_requested_ts, Activity.notes, Activity.contact_method, Activity.lead_id)
                        .join(Activity.lead)
