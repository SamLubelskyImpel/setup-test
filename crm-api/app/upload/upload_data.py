...
def lambda_handler(event: Any, context: Any) -> Any:
    ...
    try:
        ...
        with DBSession() as session:
            ...
            update_consumer_attrs(consumer_db, consumer, dealer.id, request_product)
            ...
            salesperson_db = session.query(Salesperson).filter(
                ...
                Salesperson.dealer_id == dealer.id
            ).first()
            ...
            update_salesperson_attrs(salesperson_db, salesperson, dealer.id)
