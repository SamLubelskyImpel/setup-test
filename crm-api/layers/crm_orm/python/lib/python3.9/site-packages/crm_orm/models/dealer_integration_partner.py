...
class DealerIntegrationPartner(BaseForModels):  # type: ignore
    ...
    # integration_partner = relationship(IntegrationPartner, backref=backref("dealer_integration_partners", lazy="select"))

    dealer_id = Column(Integer, ForeignKey("crm_dealer.id"))
    # dealer = relationship(Dealer, backref=backref("dealer_integration_partners", lazy="select"))
