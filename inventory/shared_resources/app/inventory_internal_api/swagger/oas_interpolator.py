...
import os
from api_interpolation_data import INVENTORY_INTERNAL_API_INTERPOLATION_DATA

print("Interpolating OAS file.")
...
yaml_path = os.path.join(os.path.dirname(__file__), "inventory_internal_api.yaml")
