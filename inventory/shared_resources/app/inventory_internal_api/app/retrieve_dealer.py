...
def lambda_handler(event: Any, context: Any) -> Any:
    ...
    try:
        ...
        with DBSession() as session:
            ...
            if partner_name:
                db_results = session.filter(
                    InvIntegrationPartner.integration_partner_name == partner_name
                )
            ...
            for dip_db, dealer_db in db_results:
                dip_data = dip_db.as_dict_custom()
                dealer_data = dealer_db.as_dict_custom()
